    ...
    <div @keydown.esc="maybeClose">
      ...
      <form @submit.prevent="submit" v-else data-testid="edit-smart-playlist-form">
        ...
        <footer>
          ...
          <Ntn white class="btn-cancel" @click.prevent="maybeClose">Cancel</Ntn>
        </footer>
      </form>
    </div>
  </FormBase>
...
const playlist = defineProps<{ playlist: Playlist }>().playlist
const mutatedPlaylist = cloneDeep(playlist)
